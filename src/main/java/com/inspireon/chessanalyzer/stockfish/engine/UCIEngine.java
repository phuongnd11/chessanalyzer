 ...
 */
package com.inspireon.chessanalyzer.stockfish.engine;

import com.inspireon.chessanalyzer.stockfish.engine.enums.Option;
import com.inspireon.chessanalyzer.stockfish.engine.enums.Variant;
import com.inspireon.chessanalyzer.stockfish.exceptions.StockfishEngineException;
...
abstract class UCIEngine {
    ...
    private String getPath(Variant variant, String override) {
        StringBuilder path = new StringBuilder("D:\\workspace\\StockfishJav\\assets\\engines\\" + "stockfish_10_x64"); //assets/engines/stockfish_20011801_x64" : override + "stockfish_10_x64");
